...
filtered_CaH_Cohort3 = subset(filtered_CaH_Cohort3, subset = pct_intronic >= 25)
filtered_CaH_Cohort3
filtered_CaH_Cohort3 = subset(filtered_CaH_Cohort3, subset = nUmi > 500)
filtered_CaH_Cohort3
filtered_CaH_Cohort3 = subset(filtered_CaH_Cohort3, subset = prob_max >= 0.9)
filtered_CaH_Cohort3

Put_Cohort3
filtered_Put_Cohort3 <- subset(Put_Cohort3, subset = pct_mito < 10)
filtered_Put_Cohort3
filtered_Put_Cohort3 = subset(filtered_Put_Cohort3, subset = pct_intronic >= 25)
filtered_Put_Cohort3
filtered_Put_Cohort3 = subset(filtered_Put_Cohort3, subset = nUmi > 500)
filtered_Put_Cohort3
filtered_Put_Cohort3 = subset(filtered_Put_Cohort3, subset = prob_max >= 0.9)
filtered_Put_Cohort3
```
...
```{r}
Idents(filtered_CaH_Cohort3) = filtered_CaH_Cohort3$RNA_snn_res.0.2

classes = c("oligo", "oligo", "oligo", "astrocyte", "oligo", "astrocyte", "microglia", "neuron", "neuron", "oligo", "opc", "neuron", "neuron", "neuron", "neuron", "neuron", "endothelial", "ependymal", "oligo", "neuron", "neuron")

filtered_CaH_Cohort3= assignCellClasses(filtered_CaH_Cohort3, classes=classes, cluster_col="RNA_snn_res.0.2", class_col = "cell_class")
...
```{r}
 ...
 Dotplot = DotPlot(object = filtered_CaH_Cohort3, features = marker_genes, group.by = "RNA_snn_res.0.2")
...
classes = c("oligo", "oligo", "oligo", "astrocyte", "neuron", "neuron", "oligo", "microglia", "neuron", "oligo", "neuron", "opc", "neuron", "oligo", "oligo", "astrocyte", "astrocyte", "oligo", "astrocyte", "endothelial", "oligo", "neuron", "opc", "neuron", "neuron", "neuron", "neuron", "immune")
...
```{r}
marker_genes <- c("SYT1", "RBFOX3", "GAD2", "SLC17A6","AQP4", "GINS3", "GFAP","C1QA", "C1QB", "CX3CR1", "P2RY12","FLT1", "DCN", "RGS5", "OLIG1", "MOG", "MOBP", "OLIG2", "VCAN", "GAPDH","ZBBX", "CFAP157", "CFAP299", "BSG","CD96", "NKG7", "SKAP1")
 Dotplot = DotPlot(object = filtered_Put_Cohort3, features = marker_genes, group.by = "RNA_snn_res.0.2")
Dotplot  <- Dotplot  + theme(axis.text.x = element_text(angle = 45, hjust = 1))+ coord_flip() 
print(Dotplot)
```

```{r}
qsave(filtered_CaH_Cohort3, "Redo_cohort_sobjs/Cohort3/filtered_CaH_Cohort3.qs")
qsave(filtered_Put_Cohort3, "Redo_cohort_sobjs/Cohort3/filtered_Put_Cohort3.qs")
```
...
#oligo
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.5 != "10")
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.5 != "11")
# 
# temp_sobj
# DimPlot(temp_sobj, group.by = "RNA_snn_res.0.2")
```
...
#endo
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.6 != "5")
# 
# temp_sobj
# DimPlot(temp_sobj, group.by = "RNA_snn_res.0.2")
```
...
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.6 != "12")
# temp_sobj
# DimPlot(temp_sobj, group.by = "RNA_snn_res.0.2")
```
...
classes =c("D1_matrix", "D2_matrix", "D1_patch", "doublet", "non_SPN", "D2_patch", "eSPN", "non_SPN", "non_SPN", "doublet", "non_SPN", "doublet", "non_SPN", "D2_eSPN", "cholinergic", "non_SPN", "doublet", "doublet", "SPN_unsure")
...
meta <- cleaned_CaH_Cohort3@meta.data
...
cleaned_CaH_Cohort3@meta.data <- cohort_metadata_joined
cleaned_CaH_Cohort3@meta.data$Sex = cleaned_CaH_Cohort3@meta.data$Sex.y
...
```{r}
qsave(cleaned_CaH_Cohort3, "Redo_cohort_sobjs/Cohort3/cleaned_CaH_Cohort3.qs")
```
...
#micro
temp_sobj
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.6 != "8")
temp_sobj
DimPlot(temp_sobj, group.by = "RNA_snn_res.0.2")
```
...
classes = c("D2_matrix", "D1_matrix", "doublet", "D1_patch", "eSPN", "D1_D2", "non_SPN", "non_SPN", "D2_patch", "non_SPN", "D2_eSPN", "doublet", "SPN_unsure", "D1_D2", "non_SPN", "cholinergic", "doublet", "doublet")
...
```{r}
qsave(cleaned_Put_Cohort3, "Redo_cohort_sobjs/Cohort3/cleaned_Put_Cohort3.qs")
```
...
classes = c("oligo", "astrocyte", "neuron", "neuron", "microglia", "oligo", "opc", "neuron", "neuron", "neuron", "endothelial", "ependymal", "neuron", "neuron", "immune")


cleaned_CaH_Put_Cohort3= assignCellClasses(cleaned_CaH_Put_Cohort3, classes=classes, cluster_col="RNA_snn_res.0.1", class_col = "cell_class_merged")

DimPlot(cleaned_CaH_Put_Cohort3, group.by = "cell_class_merged" ,label = T, raster = FALSE)

```

```{r}
qsave(cleaned_CaH_Put_Cohort3, "Redo_cohort_sobjs/Cohort3/final_CaH_Put_Cohort3.qs")
```
