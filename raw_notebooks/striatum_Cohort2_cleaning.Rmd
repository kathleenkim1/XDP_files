...
```{r}
seurat_object_list = qread("Cohort2.qs")
seurat_object_list 

Cohort_2_CaH_rxn1 = seurat_object_list[["ca_rxn1"]]
Cohort_2_CaH_rxn2 = seurat_object_list[["ca_rxn2"]]
Cohort_2_Put_rxn1 = seurat_object_list[["put_rxn1"]]
Cohort_2_Put_rxn2 = seurat_object_list[["put_rxn2"]]

Cohort_2_CaH_rxn1@meta.data 
Cohort_2_CaH_rxn2@meta.data 
Cohort_2_Put_rxn1@meta.data  
Cohort_2_Put_rxn2@meta.data  
```

```{r}
Cohort_2_CaH_rxn1 = subset(Cohort_2_CaH_rxn1, subset = donor_id != "doublet" & donor_id != "unassigned")
Cohort_2_CaH_rxn1

Cohort_2_CaH_rxn2 = subset(Cohort_2_CaH_rxn2, subset = donor_id != "doublet" & donor_id != "unassigned")
Cohort_2_CaH_rxn2

Cohort_2_Put_rxn1 = subset(Cohort_2_Put_rxn1, subset = donor_id != "doublet" & donor_id != "unassigned")
Cohort_2_Put_rxn1

Cohort_2_Put_rxn2 = subset(Cohort_2_Put_rxn2, subset = donor_id != "doublet" & donor_id != "unassigned")
Cohort_2_Put_rxn2

#calcualte pct mito

Cohort_2_CaH_rxn1@meta.data$pct_intronic = Cohort_2_CaH_rxn1$pct_intronic *100
Cohort_2_CaH_rxn2@meta.data$pct_intronic = Cohort_2_CaH_rxn2$pct_intronic *100 
Cohort_2_Put_rxn1@meta.data$pct_intronic = Cohort_2_Put_rxn1$pct_intronic *100  
Cohort_2_Put_rxn2@meta.data$pct_intronic = Cohort_2_Put_rxn2$pct_intronic *100  

mito_genes <- grep(pattern = "^MT-", x = rownames(Cohort_2_CaH_rxn1), value = TRUE)
length(mito_genes)
mito_counts <- Matrix::colSums(GetAssayData(Cohort_2_CaH_rxn1, assay = "RNA", slot = "counts")[mito_genes, ])
total_counts <- Matrix::colSums(GetAssayData(Cohort_2_CaH_rxn1, assay = "RNA", slot = "counts"))
pct_mito <- (mito_counts / total_counts) * 100
Cohort_2_CaH_rxn1$pct_mito <- pct_mito


mito_genes <- grep(pattern = "^MT-", x = rownames(Cohort_2_CaH_rxn2), value = TRUE)
length(mito_genes)
mito_counts <- Matrix::colSums(GetAssayData(Cohort_2_CaH_rxn2, assay = "RNA", slot = "counts")[mito_genes, ])
total_counts <- Matrix::colSums(GetAssayData(Cohort_2_CaH_rxn2, assay = "RNA", slot = "counts"))
pct_mito <- (mito_counts / total_counts) * 100
Cohort_2_CaH_rxn2$pct_mito <- pct_mito


mito_genes <- grep(pattern = "^MT-", x = rownames(Cohort_2_Put_rxn1), value = TRUE)
length(mito_genes)
mito_counts <- Matrix::colSums(GetAssayData(Cohort_2_Put_rxn1, assay = "RNA", slot = "counts")[mito_genes, ])
total_counts <- Matrix::colSums(GetAssayData(Cohort_2_Put_rxn1, assay = "RNA", slot = "counts"))
pct_mito <- (mito_counts / total_counts) * 100
Cohort_2_Put_rxn1$pct_mito <- pct_mito


mito_genes <- grep(pattern = "^MT-", x = rownames(Cohort_2_Put_rxn2), value = TRUE)
length(mito_genes)
mito_counts <- Matrix::colSums(GetAssayData(Cohort_2_Put_rxn2, assay = "RNA", slot = "counts")[mito_genes, ])
total_counts <- Matrix::colSums(GetAssayData(Cohort_2_Put_rxn2, assay = "RNA", slot = "counts"))
pct_mito <- (mito_counts / total_counts) * 100
Cohort_2_Put_rxn2$pct_mito <- pct_mito
...
sobj_list = list("CaH_rxn1" = Cohort_2_CaH_rxn1,
                 "CaH_rxn2" =Cohort_2_CaH_rxn2)
...
CaH_Cohort2
CaH_Cohort2@meta.data$Region = "Caudate"
CaH_Cohort2@meta.data




sobj_list = list("Put_rxn1" = Cohort_2_Put_rxn1,
                 "Put_rxn2" = Cohort_2_Put_rxn2)
...
Put_Cohort2
Put_Cohort2@meta.data$Region = "Putamen"
...
CaH_Cohort2@meta.data$Condition <- ifelse(grepl("CF$|CM$|CM2$|CM6$", CaH_Cohort2@meta.data$donor_id), "Control", "XDP")
...
Put_Cohort2@meta.data$Condition <- ifelse(grepl("CF$|CM$|CM2$|CM6$", Put_Cohort2@meta.data$donor_id), "Control", "XDP")
...
filtered_CaH_Cohort2 = subset(filtered_CaH_Cohort2, subset = pct_intronic >= 25)
filtered_CaH_Cohort2
...
filtered_Put_Cohort2 = subset(filtered_Put_Cohort2, subset = pct_intronic >= 25)
filtered_Put_Cohort2
...
DimPlot(filtered_CaH_Cohort2, group.by = "Sex")
...
```{r}
Idents(filtered_CaH_Cohort2) = filtered_CaH_Cohort2$RNA_snn_res.0.2

classes = c("oligo", "oligo", "astrocyte", "neuron", "oligo", "neuron", "microglia", "neuron", "astrocyte", "opc", "neuron", "oligo", "oligo", "oligo", "oligo", "oligo", "neuron", "neuron", "oligo", "ependymal", "endothelial", "neuron", "astrocyte", "neuron", "immune")


filtered_CaH_Cohort2= assignCellClasses(filtered_CaH_Cohort2, classes=classes, cluster_col="RNA_snn_res.0.2", class_col = "cell_class")
...
```{r}
 ...
 Dotplot = DotPlot(object = filtered_CaH_Cohort2, features = marker_genes, group.by = "cell_class")
...
DimPlot(filtered_Put_Cohort2, group.by = "Sex")
...
```{r}
qsave(filtered_CaH_Cohort2, "Redo_cohort_sobjs/Cohort2/filtered_CaH_Cohort2.qs")
qsave(filtered_Put_Cohort2, "Redo_cohort_sobjs/Cohort2/filtered_Put_Cohort2.qs")
```
...
```{r}
table(temp_sobj$RNA_snn_res.0.8)
```
```{r}
temp_sobj
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.8 != "3")
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.8 != "6")
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.8 != "8")
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.8 != "10")
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.8 != "12")
temp_sobj
...
#ependymal
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.3 != "5")
...
#Endo
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.3 != "3")
...
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.3 != "3")
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.3 != "7")
...
classes =c("D2_matrix", "D1_matrix", "D1_matrix", "doublet", "D1_patch", "SPN_unsure", "non_SPN", "eSPN", "doublet", "D2_patch", "non_SPN", "non_SPN", "doublet", "SPN_unsure", "non_SPN", "doublet", "non_SPN", "cholinergic", "doublet", "doublet", "doublet")
...
DimPlot(cleaned_CaH_Cohort2, group.by = "donor_id") 
DimPlot(cleaned_CaH_Cohort2, group.by = "library") 
...
meta <- cleaned_CaH_Cohort2@meta.data
...
cleaned_CaH_Cohort2@meta.data <- cohort_metadata_joined
cleaned_CaH_Cohort2@meta.data$Sex = cleaned_CaH_Cohort2@meta.data$Sex.y
 cleaned_CaH_Cohort2@meta.data$Sex.y = NULL
  cleaned_CaH_Cohort2@meta.data$Sex.x = NULL
  cleaned_CaH_Cohort2@meta.data$Condition = cleaned_CaH_Cohort2@meta.data$Condition.x
cleaned_CaH_Cohort2@meta.data$Condition.x = NULL
cleaned_CaH_Cohort2@meta.data$Condition.y = NULL
...
```{r}
qsave(cleaned_CaH_Cohort2, "Redo_cohort_sobjs/Cohort2/cleaned_CaH_Cohort2.qs")
```
...
#oligo
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.4 != "7")
# temp_sobj
# DimPlot(temp_sobj, group.by = "RNA_snn_res.0.4")
```
...
#endo
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.7 != "3")
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.7 != "6")
# temp_sobj
...
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.6 != "9")
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.6 != "10")
# temp_sobj
# DimPlot(temp_sobj, group.by = "RNA_snn_res.0.6")
# 
# temp_sobj$cell_class[temp_sobj$RNA_snn_res.0.6 == "11"] = "ependymal"
```
...
classes = c("D2_matrix", "D1_matrix", "D1_D2", "doublet", "D1_patch", "eSPN", "doublet", "D2_patch", "non_SPN", "non_SPN", "doublet", "D1_D2", "D2_eSPN", "non_SPN", "doublet", "cholinergic", "doublet")
...
DimPlot(cleaned_Put_Cohort2, group.by = "donor_id") 
DimPlot(cleaned_Put_Cohort2, group.by = "library") 
...
meta <- cleaned_Put_Cohort2@meta.data
meta$cell_id <- rownames(meta)
...
# Update Seurat object
cleaned_Put_Cohort2@meta.data <- cohort_metadata_joined
cleaned_Put_Cohort2@meta.data$Sex = cleaned_Put_Cohort2@meta.data$Sex.y
 cleaned_Put_Cohort2@meta.data$Sex.y = NULL
  cleaned_Put_Cohort2@meta.data$Sex.x = NULL
  cleaned_Put_Cohort2@meta.data$Condition = cleaned_Put_Cohort2@meta.data$Condition.x
cleaned_Put_Cohort2@meta.data$Condition.x = NULL
cleaned_Put_Cohort2@meta.data$Condition.y = NULL
...
```{r}
qsave(cleaned_Put_Cohort2, "Redo_cohort_sobjs/Cohort2/cleaned_Put_Cohort2.qs")
```
...
```{r}
Idents(cleaned_CaH_Put_Cohort2) = cleaned_CaH_Put_Cohort2$RNA_snn_res.0.4

classes = c("oligo", "oligo", "astrocyte", "neuron", "oligo", "neuron", "microglia", "opc", "astrocyte", "oligo", "neuron", "neuron", "neuron", "neuron", "neuron", "endothelial", "ependymal", "oligo", "neuron", "immune", "neuron", "neuron")

cleaned_CaH_Put_Cohort2= assignCellClasses(cleaned_CaH_Put_Cohort2, classes=classes, cluster_col="RNA_snn_res.0.4", class_col = "cell_class_merged")

DimPlot(cleaned_CaH_Put_Cohort2, group.by = "cell_class_merged" ,label = T, raster = FALSE)

```

```{r}
qsave(cleaned_CaH_Put_Cohort2, "Redo_cohort_sobjs/Cohort2/final_CaH_Put_Cohort2.qs")
```
...
# Create the forest plot with ticks on error bars, axis lines with ticks, RdBu color map, and opaque white circles on top
ggplot(masc_df, aes(y = cluster_name, x = log2_or)) +
  ggtitle("Combined Cohort 2 CaH + Put") +
  geom_vline(xintercept = 0, linetype = "dotted", color = "gray") +  # Add dotted vertical line at x=0
  geom_segment(aes(x = log2_or_ci_low, xend = log2_or_ci_high, y = cluster_name, yend = cluster_name, color = log2_or), size = 1) +  # Add horizontal error bars
  geom_point(size = 3, aes(color = log2_or), shape = 1) +  # Add points for effect sizes
  geom_point(size = 3, shape = 21, fill = "white") +  # Add opaque white circle on top of the error bar line
...
cleaned_CaH_Put_Cohort2 <- AddModuleScore_UCell(cleaned_CaH_Put_Cohort2,features = list(antigen_processing = antigen_processing_genes), name = '_scores')
