...
filtered_CaH_Cohort1 = subset(filtered_CaH_Cohort1, subset = pct_intronic >= 25)
filtered_CaH_Cohort1
filtered_CaH_Cohort1 = subset(filtered_CaH_Cohort1, subset = nUmi > 500)
filtered_CaH_Cohort1
filtered_CaH_Cohort1 = subset(filtered_CaH_Cohort1, subset = prob_max >= 0.9)
filtered_CaH_Cohort1
...
filtered_Put_Cohort1 = subset(filtered_Put_Cohort1, subset = pct_intronic >= 25)
filtered_Put_Cohort1
filtered_Put_Cohort1 = subset(filtered_Put_Cohort1, subset = nUmi > 500)
filtered_Put_Cohort1
filtered_Put_Cohort1 = subset(filtered_Put_Cohort1, subset = prob_max >= 0.9)
filtered_Put_Cohort1
```
...
classes = c("oligo", "oligo", "astrocyte", "oligo", "microglia", "oligo", "astrocyte", "neuron", "neuron", "astrocyte", "opc", "neuron", "oligo", "endothelial", "oligo", "ependymal", "oligo", "neuron", "neuron", "immune")
...
classes = c("oligo", "oligo", "astrocyte", "neuron", "oligo", "microglia", "neuron", "oligo", "astrocyte", "oligo", "opc", "neuron", "neuron", "neuron", "neuron", "oligo", "endothelial", "neuron", "neuron", "neuron", "oligo", "neuron")
...
```{r}
qsave(filtered_CaH_Cohort1, "Redo_cohort_sobjs/Cohort1/filtered_CaH_Cohort1.qs")
qsave(filtered_Put_Cohort1, "Redo_cohort_sobjs/Cohort1/filtered_Put_Cohort1.qs")
```
...
#opc
temp_sobj
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.2 != "3")
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.2 != "4")
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.2 != "5")
temp_sobj
...
#microglia
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.3 != "6")
...
#astro
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.7 != "8")
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.7 != "13")
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.7 != "14")
# temp_sobj$cell_class[temp_sobj$RNA_snn_res.0.7 == "5"] = "ependymal"
# temp_sobj
...
classes =c("D1_matrix", "D2_matrix", "D1_D2", "eSPN", "non_SPN", "D1_patch", "non_SPN", "doublet", "D2_patch", "non_SPN", "D1_D2", "non_SPN", "doublet", "D1_D2", "non_SPN", "doublet", "non_SPN", "non_SPN")
...
# Preserve cell names
meta <- cleaned_CaH_Cohort1@meta.data
meta$cell_id <- rownames(meta)

# Join on donor_id
cohort_metadata_joined <- left_join(meta, cohort_metadata, by = c("donor_id" = "Donor"))
...
cleaned_CaH_Cohort1@meta.data <- cohort_metadata_joined
cleaned_CaH_Cohort1@meta.data
```
...
```
```{r}
cleaned_CaH_Cohort1@meta.data$Sex = cleaned_CaH_Cohort1@meta.data$Sex.y
...
```{r}
qsave(cleaned_CaH_Cohort1, "Redo_cohort_sobjs/Cohort1/cleaned_CaH_Cohort1.qs")
```
...
#microglia
# temp_sobj
# temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.3 != "4")
# temp_sobj$cell_class[temp_sobj$RNA_snn_res.0.3 != "7"] = "immune"
# temp_sobj
# DimPlot(temp_sobj, group.by = "RNA_snn_res.0.2")
```
...
classes = c("D2_matrix", "D1_matrix", "doublet", "eSPN", "D1_D2", "glutamatergic", "D1_patch", "non_SPN", "D2_patch", "non_SPN", "non_SPN", "doublet", "non_SPN", "D2_eSPN", "D1_unsure", "doublet", "non_SPN", "non_SPN", "doublet")
...
```
```{r}
cleaned_Put_Cohort1$cell_class[cleaned_Put_Cohort1$cell_class == "microglia"] = "immune"
cleaned_Put_Cohort1$cell_class[cleaned_Put_Cohort1$neuron_cell_class == "immune"] = "microglia"

cleaned_Put_Cohort1$neuron_cell_class[cleaned_Put_Cohort1$cell_class == "microglia"] = "microglia"
cleaned_Put_Cohort1$neuron_cell_class[cleaned_Put_Cohort1$cell_class == "immune"] = "immune"
...
```{r}
# Preserve cell names
meta <- cleaned_Put_Cohort1@meta.data
meta$cell_id <- rownames(meta)
...
# Update Seurat object
cleaned_Put_Cohort1@meta.data <- cohort_metadata_joined
cleaned_Put_Cohort1@meta.data$Sex = cleaned_Put_Cohort1@meta.data$Sex.y
...
```{r}
qsave(cleaned_Put_Cohort1, "Redo_cohort_sobjs/Cohort1/cleaned_Put_Cohort1.qs")
```
...
```{r}
FeaturePlot(cleaned_CaH_Put_Cohort1, features = c("PPP1R1B", "CASZ1"),raster=FALSE) 
```

```{r}
Idents(cleaned_CaH_Put_Cohort1) = cleaned_CaH_Put_Cohort1$RNA_snn_res.0.1

classes = c("oligo", "astrocyte", "neuron", "microglia", "opc", "neuron", "neuron", "endothelial", "neuron", "ependymal", "immune", "neuron")


cleaned_CaH_Put_Cohort1= assignCellClasses(cleaned_CaH_Put_Cohort1, classes=classes, cluster_col="RNA_snn_res.0.1", class_col = "cell_class_merged")

DimPlot(cleaned_CaH_Put_Cohort1, group.by = "cell_class_merged" ,label = T, raster = FALSE)

```

```{r}
qsave(cleaned_CaH_Put_Cohort1, "Redo_cohort_sobjs/Cohort1/final_CaH_Put_Cohort1.qs")
```
