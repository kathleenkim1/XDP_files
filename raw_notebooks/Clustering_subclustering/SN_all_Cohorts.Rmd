...
classes = c("oligo", "microglia", "astrocyte", "opc", "neuron", "neuron", "oligo", "endothelial", "oligo", "oligo", 
  "neuron", "microglia", "neuron", "oligo", "immune", "oligo", "neuron", "microglia", "oligo", "endothelial")
...
```{r}
 ...
 Dotplot = DotPlot(object = filtered_SN_Cohort1, features = marker_genes, group.by = "cell_class")
...
qsave(filtered_SN_Cohort1, "Cohort1/sobjs/filtered_SN_Cohort1.qs")
```
...
```{r}
temp_sobj = subset(filtered_SN_Cohort1, subset = cell_class == "opc")
...
```{r}
temp_sobj
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.2 != "2" & RNA_snn_res.0.2 != "4" & RNA_snn_res.0.2 != "5" & RNA_snn_res.0.2 != "6")
temp_sobj
...
```{r}
qsave(cleaned_SN_Cohort1, "Cohort1/sobjs/cleaned_SN_Cohort1.qs")
```
...
filtered_SN_Cohort2
filtered_SN_Cohort2 = subset(filtered_SN_Cohort2, subset = pct_intronic >= 0.25)
filtered_SN_Cohort2
...
```{r}
Idents(filtered_SN_Cohort2) = filtered_SN_Cohort2$RNA_snn_res.0.2

classes = c("oligo", "astrocyte", "neuron", "microglia", "microglia", "microglia", "neuron", "ependymal", "neuron", "oligo", 
  "neuron", "microglia", "oligo", "opc", "neuron", "oligo", "endothelial")


filtered_SN_Cohort2= assignCellClasses(filtered_SN_Cohort2, classes=classes, cluster_col="RNA_snn_res.0.2", class_col = "cell_class")
...
```{r}
qsave(SN_Cohort2, "Cohort2/sobjs/SN_Cohort2_unfiltered.qs")
qsave(filtered_SN_Cohort2, "Cohort2/sobjs/filtered_SN_Cohort2.qs")
```
...
```{r}
temp_sobj = subset(filtered_SN_Cohort2, subset = cell_class == "opc")
...
```{r}
temp_sobj
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.2 != "3" &  RNA_snn_res.0.2 != "4" &  RNA_snn_res.0.2 != "5" &  RNA_snn_res.0.2 != "6")
temp_sobj
DimPlot(temp_sobj, group.by = "RNA_snn_res.0.2")
```
```{r}
...
```{r}
qsave(cleaned_SN_Cohort2, "Cohort2/sobjs/cleaned_SN_Cohort2.qs")
```
...
filtered_SN_Cohort3
filtered_SN_Cohort3 = subset(filtered_SN_Cohort3, subset = pct_intronic >= 0.25)
filtered_SN_Cohort3
...
```{r}
Idents(filtered_SN_Cohort3) = filtered_SN_Cohort3$RNA_snn_res.0.2

classes = c("oligo", "astrocyte", "microglia", "oligo", "neuron", "oligo", "opc", "neuron", "neuron", "oligo", 
  "oligo", "opc", "endothelial", "astrocyte", "immune", "microglia", "neuron", "neuron")

filtered_SN_Cohort3= assignCellClasses(filtered_SN_Cohort3, classes=classes, cluster_col="RNA_snn_res.0.2", class_col = "cell_class")
...
```{r}
 marker_genes <- c("SYT1", "RBFOX3", "GAD2", "SLC17A6","AQP4", "GINS3", "GFAP","C1QA", "C1QB", "CX3CR1", "P2RY12","FLT1", "DCN", "RGS5", "OLIG1", "MOG", "MOBP", "OLIG2", "VCAN", "GAPDH","ZBBX", "CFAP157", "CFAP299", "BSG","CD96", "NKG7", "SKAP1")
 Dotplot = DotPlot(object = filtered_SN_Cohort3, features = marker_genes, group.by = "cell_class")
Dotplot  <- Dotplot  + theme(axis.text.x = element_text(angle = 45, hjust = 1))+ coord_flip() 
print(Dotplot)
```
...
```{r}
qsave(SN_Cohort3, "Cohort3/sobjs/SN_Cohort3_unfiltered.qs")
qsave(filtered_SN_Cohort3, "Cohort3/sobjs/filtered_SN_Cohort3.qs")
```
...
```{r}
temp_sobj = subset(filtered_SN_Cohort3, subset = cell_class == "opc")
...
```{r}
qsave(cleaned_SN_Cohort3, "Cohort3/sobjs/cleaned_SN_Cohort3.qs")
```
...
```{r}
cleaned_SN_Cohort1 = qread("Cohort1/sobjs/cleaned_SN_Cohort1.qs")
cleaned_SN_Cohort2= qread("Cohort2/sobjs/cleaned_SN_Cohort2.qs")
cleaned_SN_Cohort3 = qread("Cohort3/sobjs/cleaned_SN_Cohort3.qs")
cleaned_SN_Cohort1@meta.data
cleaned_SN_Cohort2@meta.data 
cleaned_SN_Cohort3@meta.data
```
#edit 5/11 - pct_intronic filtering to 25 not 0.25
```{r}
cleaned_SN_Cohort1 = subset(cleaned_SN_Cohort1, subset = pct_intronic >= 25)
cleaned_SN_Cohort2 = subset(cleaned_SN_Cohort2, subset = pct_intronic >= 25)
cleaned_SN_Cohort3= subset(cleaned_SN_Cohort3, subset = pct_intronic >= 25)

cleaned_SN_Cohort1@meta.data
cleaned_SN_Cohort2@meta.data 
cleaned_SN_Cohort3@meta.data
#roughly 4000,3000,1000 cells removed
```
...
```{r}
All_XDP_Cohorts_SN$Brain_bank[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = "SCF"
All_XDP_Cohorts_SN$Cohort[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = "2"
All_XDP_Cohorts_SN$Year_collected[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 2021
All_XDP_Cohorts_SN$Age_of_Onset[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 34
All_XDP_Cohorts_SN$Age_of_Death[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 59
All_XDP_Cohorts_SN$Disease_duration[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 25
All_XDP_Cohorts_SN$RQS[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 5.82
All_XDP_Cohorts_SN$DV200[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 0.74
All_XDP_Cohorts_SN$MQS_numerical[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = 5
All_XDP_Cohorts_SN$MQS[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = "A"
All_XDP_Cohorts_SN$Immediate.Cause.of.Death[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = "Cerebal Centrusion"
All_XDP_Cohorts_SN$Infection_related_death[All_XDP_Cohorts_SN$donor_id == "SCF_21_036B"] = "No"
