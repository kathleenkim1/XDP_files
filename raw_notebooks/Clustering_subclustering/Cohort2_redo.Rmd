...
classes = c("oligo", "astrocyte", "oligo", "neuron", "oligo", "neuron", "microglia", "astrocyte", "opc", "oligo", 
  "oligo", "neuron", "neuron", "oligo", "oligo", "neuron", "oligo", "oligo", "oligo", "neuron", "endothelial", "ependymal", "neuron", "astrocyte", "neuron", "astrocyte", "immune")
...
```{r}
Idents(filtered_Put_Cohort2) = filtered_Put_Cohort2$RNA_snn_res.0.2

classes = c("oligo", "oligo", "oligo", "astrocyte", "neuron", "neuron", "oligo", "oligo", "oligo", "microglia", 
  "oligo", "oligo", "opc", "neuron", "neuron", "oligo", "neuron", "endothelial", "neuron", "neuron", "neuron", "immune")


filtered_Put_Cohort2= assignCellClasses(filtered_Put_Cohort2, classes=classes, cluster_col="RNA_snn_res.0.2", class_col = "cell_class")
...
```{r}
marker_genes <- c("SYT1", "RBFOX3", "GAD2", "SLC17A6","AQP4", "GINS3", "GFAP","C1QA", "C1QB", "CX3CR1", "P2RY12","FLT1", "DCN", "RGS5", "OLIG1", "MOG", "MOBP", "OLIG2", "VCAN", "GAPDH","ZBBX", "CFAP157", "CFAP299", "BSG","CD96", "NKG7", "SKAP1")
 Dotplot = DotPlot(object = filtered_Put_Cohort2, features = marker_genes, group.by = "cell_class")
Dotplot  <- Dotplot  + theme(axis.text.x = element_text(angle = 45, hjust = 1))+ coord_flip() 
print(Dotplot)
```
...
```{r}
temp_sobj
temp_sobj = subset(temp_sobj, subset = RNA_snn_res.0.2 != "2" & RNA_snn_res.0.2 != "3" & RNA_snn_res.0.2 != "4")
temp_sobj
...
classes =c("D1_matrix", "D2_matrix", "D1_patch", "eSPN", "doublet", "non_SPN", "D2_patch", "D2_patch", "doublet", "doublet", 
  "doublet", "SPN_unsure", "non_SPN", "doublet", "non_SPN", "non_SPN", "doublet", "cholinergic", "D1_patch")
...
```{r}
table(cleaned_CaH_Cohort2$donor_id)
...
cleaned_CaH_Cohort2@meta.data = merge(cleaned_CaH_Cohort2@meta.data, cohort_metadata, by.x = "donor_id", by.y = "Donor")
cleaned_CaH_Cohort2@meta.data

cleaned_CaH_Cohort2@meta.data$Sex = cleaned_CaH_Cohort2@meta.data$Sex.x
...
classes = c("D2_matrix", "D1_matrix", "D2_unsure", "doublet", "eSPN", "D1_patch", "D2_patch", "non_SPN", "non_SPN", "non_SPN", 
  "doublet", "non_SPN", "D1_D2", "D2_eSPN", "non_SPN", "non_SPN", "D1_matrix", "doublet", "cholinergic")
...
DimPlot(cleaned_Put_Cohort2, group.by = "library", label=T)
DimPlot(cleaned_Put_Cohort2, group.by = "Condition", label=T)

cleaned_Put_Cohort2@meta.data = merge(cleaned_Put_Cohort2@meta.data, cohort_metadata, by.x = "donor_id", by.y = "Donor")
cleaned_Put_Cohort2@meta.data

cleaned_Put_Cohort2@meta.data$Sex = cleaned_Put_Cohort2@meta.data$Sex.x
...
```{r}
Idents(cleaned_CaH_Put_Cohort2) = cleaned_CaH_Put_Cohort2$RNA_snn_res.0.1

classes = c("oligo", "astrocyte", "neuron", "ependymal", "neuron", "neuron", "immune", "neuron", "neuron", "microglia", 
  "opc", "oligo", "neuron", "neuron", "endothelial")

cleaned_CaH_Put_Cohort2= assignCellClasses(cleaned_CaH_Put_Cohort2, classes=classes, cluster_col="RNA_snn_res.0.1", class_col = "final_cell_class_merged")
