...
<!-- cellranger and cellbender outputs: -->
...
all(colnames(filtered_dgc) == rownames(metadata))
  ...
  metadata
```
#NOTE: there are NA donor_ids in metadata but these cells are in filtered_dgc--> does that mean these were just cells vireo could not identify? If so, why is it not in unassigned? Regardless, filtered out about 2400 cells
#cahrxn2, 1858
#put1 866
#put2, 1958
