...
```{r}
cohort_1 = qread("cleaned_CaH_Put_Cohort1_sct_ucell.qs")
cohort_2 = qread("cleaned_CaH_Put_Cohort2_sct_ucell.qs")
cohort_3 = qread("cleaned_CaH_Put_Cohort3_sct_ucell.qs")
...
Idents(cohort_1) = "final_cell_class_merged"
Idents(cohort_2) = "final_cell_class_merged"
Idents(cohort_3) = "final_cell_class_merged"
```
```{r}
DefaultAssay(cohort_1) = "RNA"
DefaultAssay(cohort_2) = "RNA"
DefaultAssay(cohort_3) = "RNA"
...
```{r}
sobj_list = list(cohort_1, cohort_2, cohort_3)
...
All_XDP_Cohorts = SCTransform(All_XDP_Cohorts, vars.to.regress = "pct_mito", verbose = FALSE)
DefaultAssay(All_XDP_Cohorts) = "SCT"
All_XDP_Cohorts
```
...
DimPlot(All_XDP_Cohorts, group.by = "Region", label=T, raster = F)
DimPlot(All_XDP_Cohorts, group.by = "final_cell_class_merged", label=T, raster = F)
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.2", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.3", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.4", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.5", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.6", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.7", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.8", label=T, raster = F)
```
...
DimPlot(All_XDP_Cohorts, group.by = "donor_id", raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.05", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.1", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.2", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.3", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.4", label=T, raster = F) 
DimPlot(All_XDP_Cohorts, group.by = "SCT_snn_res.0.5", label=T, raster = F) 
...
DimPlot(All_XDP_Cohorts, group.by = "Cohort", raster = F)
DimPlot(All_XDP_Cohorts, group.by = "library_cohort", raster = F)
DimPlot(All_XDP_Cohorts, group.by = "final_cell_class_merged", label=T, raster = F)
DimPlot(All_XDP_Cohorts, group.by = "Condition", label=T, raster = F)
DimPlot(All_XDP_Cohorts, group.by = "Region", label=T, raster = F)
```

```{r}
FeaturePlot(All_XDP_Cohorts, features = c("SYT1", "AQP4", "C1QA","FLT1"),raster=FALSE)
FeaturePlot(All_XDP_Cohorts, features = c("OLIG1", "OLIG2", "MOG" ,"CD96"),raster=FALSE) 
FeaturePlot(All_XDP_Cohorts, features = c("MBP", "MOBP", "WIF1", "TNC"),raster=FALSE)
FeaturePlot(All_XDP_Cohorts, features = c("RBFOX3", "CX3CR1", "GFAP" ,"AQP4"),raster=FALSE) 
FeaturePlot(All_XDP_Cohorts, features = c("GAD1", "GAD2", "SLC17A7" ,"SLC17A6"),raster=FALSE) 
...
```{r}
Idents(All_XDP_Cohorts) = All_XDP_Cohorts$SCT_snn_res.0.2

classes = c("oligo", "neuron", "astrocyte", "oligo", "oligo", "microglia", "opc", "oligo", "neuron", "neuron", 
  "endothelial", "neuron", "neuron", "ependymal", "immune", "neuron", "neuron")


All_XDP_Cohorts= assignCellClasses(All_XDP_Cohorts, classes=classes, cluster_col="SCT_snn_res.0.2", class_col = "final_cell_class_merged_harmony")

DimPlot(All_XDP_Cohorts, group.by = "final_cell_class_merged_harmony" ,label = T, raster = FALSE)
Idents(All_XDP_Cohorts) = "final_cell_class_merged_harmony"
```
```{r}
...
Dotplot = DotPlot(object = All_XDP_Cohorts, features = marker_genes, group.by = "final_cell_class_merged_harmony")
