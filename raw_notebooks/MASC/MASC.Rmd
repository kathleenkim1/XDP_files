...
pd$cell_class[pd$cell_class == "D1_SPN_4?"] = "D1_SPN_4"
...
```{r}
caudate_neurons_filtered$cell_class[caudate_neurons_filtered$cell_class == "D1_SPN_4?"] = "D1_SPN_4"
DimPlot(caudate_neurons_filtered, label = TRUE)

```

```{r}
DimPlot(caudate_neurons_filtered, group.by= "cell_class", label= TRUE)
DimPlot(caudate_neurons_filtered, group.by= "Condition")
...
masc_df
write.csv(masc_df, "MASC/putamen_neurons_masc_df.csv")
```
...
```
```{r}
FeaturePlot(caudate_neurons_filtered,  features = c("EPHA4", "SEMA3E"))
